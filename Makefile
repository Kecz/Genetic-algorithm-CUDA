...
objdir = obj
srcdir = src
objects = $(objdir)/cpu_implementation_lib.o $(objdir)/config.o $(objdir)/genetic_algorithm.o
...
debug:	$(objects)
	...
	cuda-gdb run_algorithm_debug.o $(filename_results_cpu) $(filename_results_gpu)
